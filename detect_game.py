...
# load the shapes image, then describe each of the images in the imag
...
for (j, c) in enumerate(cnts):
    # if the index of the current contour does not equal the indwx
...
# draw the bounding boxx around the detected shape
...
cv2.imshow("Dtected Shapes", shapesImage)
cv2.waitKey(0)
