...
# constuct the argument parse and parse the argumens
...
# initialize the image descriptor alone with the image matrix
...
# loop over te input dataset of images
for imagePath in imagePaths:
    # load the image, describe the image, then updage the list of data
