...
ap.add_argument("-n", "--num-images", type=int, default=500, help="# of disctractor images to generate")
...
for i in xrange(0, args["num_images"]):
    ...
    # center of the circle , the generate theradius of the
    ...
    tmpUUID = uuid.uuid4()
    cv2.imwrite("{}/{}.jpg".format(args["output"], tmpUUID), image)
    print "saved to {}/{}.jpg".format(args["output"], tmpUUID)

# allocate meory for the rectangle image, then generate the starting
...
tmpUUID = uuid.uuid4()
cv2.imwrite("{}/Rect_{}.jpg".format(args["output"], tmpUUID), image)
print "[Rectangle] saved to {}/Rect_{}.jpg".format(args["output"], tmpUUID)
