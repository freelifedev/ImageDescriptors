...
# construct the argumnt parse and parse the arguments
ap = argparse.ArgumentParser()
ap.add_argument("-d", "--dataset", required=True, help="Path to the dataet directory")
...
for imagePath in imagePaths:
    # load the image, convert it to graysale , and threshold it
    ...
    # extract the ROI from the image, resiz it to a canonical size,
    # compute the Hu Moments feature vector for the ROI, and upage
    # the data matrix
...
# compute the distance beteen all entires in the data matrix, ten
